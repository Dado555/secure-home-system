package rs.securehome.admin.aspects;
...
public class LogAspect {
    ...
    @AfterReturning("@annotation(rs.securehome.admin.annotation.Log)")
    ...
    @AfterThrowing(value = "@annotation(rs.securehome.admin.annotation.Log)", throwing = "exception")
